    ...
    <div className="pb-20 pt-36">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
           ...
           */}
          <TextGenerateEffect
            words="Discover engineering solutions with us in the heart of Brooklyn"
            className="text-center text-[40px] md:text-5xl lg:text-6xl"
          />

          <p className="text-center md:tracking-wider mb-4 text-lg md:text-lg lg:text-2xl">
            Hi! I&apos;m Young-In, a software engineer based in Brooklyn, NY.
          </p>
